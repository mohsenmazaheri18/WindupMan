...
public class Trigger_DoorE : MonoBehaviour
{
    private static Trigger_DoorE _triggerDoorE;
    //Door
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        //Door E
        if (other.CompareTag("Box_E"))
        {
            doorE.GetComponent<Animator>().Play("Door_E_4");
